...
const PlatformModal = ({ onClose, onResult }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        " https://p7g0npdh71.execute-api.ap-south-1.amazonaws.com/api/v1/platform",
        {
          category,
          platform,
        },
      ...
      console.log("PLATFORM FETCH SUCCESS:", response.data);

      // send data back to Dashboard (same pattern as CategoryModal)
  ...
  return (
    ...
    >
      <motion.div
        className="relative w-[340px] rounded-xl border border-cyan-400 
      ...
      >
        ...
        <h2
          className="mb-6 text-center font-mono text-lg 
